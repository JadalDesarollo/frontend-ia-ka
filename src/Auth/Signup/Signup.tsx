										...
										<div className="w-100">
											...
											<Row className="row">
												<Col className="col-12">
													<Link role="button" to={`${import.meta.env.BASE_URL}auth/login`} className="btn btn-lg btn-primary btn-block px-4"><i className="fe fe-arrow-right"></i> Crear nueva cuenta</Link>
												</Col>
