...
function MoreCuestions2({ nextStep, handleFormData, values, prevStep }: any) {
    ...
    return (
        <div>
            ...
            <CuestionMultiple cuestion={"Mi Consumo Alcohol es"} name={"consumoAlcohol"} alternatives={['No consumo', 'Solo en ocasiones', 'Con Frecuencia ']} isValue0={true} />

            <CuestionMultiple cuestion={"Puedo decir que mi nivel de Estrés es"} name={"nivelEstres"} alternatives={['Bajo', 'Moderado', 'Alto']} />

            <CuestionMultiple cuestion={"Mi actividad física es"} name={"actividadFisica"} alternatives={['activo', 'moderado', 'sendentario']} />
