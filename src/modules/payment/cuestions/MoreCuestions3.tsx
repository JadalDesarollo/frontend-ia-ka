...
function MoreCuestions3({ nextStep, handleFormData, values, prevStep }: any) {
    ...
    return (
        <div>
            ...
            <CustomCuestion cuestion={"Tengo Antecedentes Renales"} name={"antecedentesRenales"} />
